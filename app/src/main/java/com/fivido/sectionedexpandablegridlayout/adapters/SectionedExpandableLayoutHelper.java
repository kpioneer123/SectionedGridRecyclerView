...
import com.fivido.sectionedexpandablegridlayout.Common;
import com.fivido.sectionedexpandablegridlayout.DividerItemDecoration;
...
public class SectionedExpandableLayoutHelper implements SectionStateChangeListener {
    ...
    public SectionedExpandableLayoutHelper(Context context, RecyclerView recyclerView, ItemClickListener itemClickListener,
     ...
     //   recyclerView.addItemDecoration(new DividerItemDecoration(context, LinearLayoutManager.VERTICAL, R.color.color6, Common.dip2px(context, (float) 1)));
